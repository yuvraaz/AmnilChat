...
import com.example.walkitwaki.R;

public class MainActivity extends AppCompatActivity implements WalkieService.StateListener, Channel.StateListener {
        ...
        public void onClick(DialogInterface dialog, int which) {
            if (which == DialogInterface.BUTTON_POSITIVE) {
                ...
                if (m_stationName.compareTo(stationName) != 0) {
                    final String title = stationName;
                    setTitle(title);
